...
namespace ArcSoftFace.SDKUtil
{
    ...
    public class ASFFunctions
    {
        ...
        public static extern int ASFGetActiveFileInfo(IntPtr pActiveFileInfo);
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        unsafe public static extern int ASFGetActiveDeviceInfo(IntPtr deviceinfo);
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns>调用结果</returns>
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFFaceFeatureExtract(IntPtr pEngine, int width, int height, int format, IntPtr imgData, IntPtr faceInfo , ArcSoftFace.SDKModels.ASF_RegisterOrNot aSF_RegisterOrNot,int mask, IntPtr faceFeature);
        ...
        /// <returns>调用结果</returns>
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern ArcSoftFace.SDKModels.ASF_VERSION ASFGetVersion();

        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFSetLivenessParam(IntPtr hEngine, IntPtr threshold);

        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFRegisterFaceFeature(IntPtr hEngine, IntPtr featureInfoList, int num );

        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFGetFaceCount(IntPtr hEngine, IntPtr pnum);

        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFGetFaceFeature(IntPtr hEngine, int searchId , IntPtr featureInfo);
    }
}